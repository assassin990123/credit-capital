...
contract RevenueController is AccessControl {
    ...
    constructor (address _capl, address _treasuryStorage, address _treasuryFund) {
        capl = IERC20(_capl);
     ...
     */
    function treasuryIncome(address _token, uint256 _principal, uint256 _profit) external {}
