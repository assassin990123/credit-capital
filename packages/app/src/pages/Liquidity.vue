      ...
      <div class="panel-container inner-container">
        <div class="panel stake-panel">
          ...
          <div class="panel-content swap-panel-content liquidity-box-main">
            ...
            <div class="explainer">
              Deposit any combination of USDC and/or CAPL tokens into the
              liquidity pool. Liquidity providers earn a portion of swap fees
              (0.3%) generated by users. Want to earn more? Consider
              <router-link to="stake" class="button">Staking</router-link> your
              tokens.
            </div>
          </div>
        </div>
...
watchEffect(async () => {
  ...
  if (
    ...
    usdcLiquidity.value = Number(
      parseFloat(usdcLiquidity.value.toString()).toFixed(6)
    );
    caplLiquidity.value = Number(
      parseFloat(caplLiquidity.value.toString()).toFixed(18)
    );
