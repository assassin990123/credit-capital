    ...
    scrollspy: function (l) {
      ...
      function c(t) {
        for (var e = 0; e < t.length; e++)
          p(t[e]).parent().removeClass(l.activeClass);
      }
      var h = "";
      return this.each(function () {
        for (
          var o = this, t = p(l.container), i = p(o).find("a"), e = 0;
          e < i.length;
          e++
        ) {
          var a = i[e];
          p(a).on("click", function (t) {
            var e,
              ...
              n = p(a);
            0 < n.length &&
              ((e = s(n.offset().top, l.offset)),
              l.animate
                ? p("html, body").animate({ scrollTop: e }, l.duration)
                : r.scrollTo(0, e),
              t.preventDefault());
          });
        }
        ...
        function n() {
          for (
            ...
            if (e.top >= n.top && e.top < n.bottom) {
              ...
              if (
                ...
                l.onChange &&
                  h !== r &&
                  (l.onChange(n.element, p(o), e), (h = r)),
                  l.replaceState && history.replaceState({}, "", "/" + r),
                  c(i),
                  t.parent().addClass(l.activeClass);
                break;
              }
            }
          }
          !t &&
            ...
            c(i),
            (h = "exit"),
            l.replaceState && history.replaceState({}, "", "/"));
        }
        var f = (function (t) {
          for (var e = [], a = 0; a < t.length; a++) {
            ...
            0 < f.length &&
              ((r =
                (n = Math.floor(f.offset().top)) + Math.floor(f.outerHeight())),
              e.push({ element: f, hash: i, top: n, bottom: r }));
          }
          return e;
        })(i);
  ...
  (a.fn.scrollUp = function (l) {
    ...
    (a.fn.scrollUp.init = function (l) {
      var o,
        ...
        s,
        t,
        c = (a.fn.scrollUp.settings = a.extend({}, a.fn.scrollUp.defaults, l)),
        i = !1,
        n = c.scrollTrigger
          ? a(c.scrollTrigger)
    ...
    (this.WOW =
            ...
            e.push(
              function () {
                for (
                  ...
                  (l = t[n]),
                    e.push(
                      (o["" + l + s.charAt(0).toUpperCase() + s.substr(1)] = r)
                    );
                return e;
              }.call(this)
            );
      ...
      (s.prototype.vendorCSS = function (t, e) {
        for (
          ...
          (n = s[r]), (o = o || i.getPropertyCSSValue("-" + n + "-" + e));
        return o;
      }),
...
!(function (a, b, c, d) {
  ...
  a.extend(a.fn, {
    accrue: function (b) {
      return (
        (b = a.extend({ calculationMethod: g }, a.fn.accrue.options, b)),
        this.each(function () {
          var c = a(this);
          ...
          var d;
          ".results" === b.response_output_div
            ? (0 === c.find(".results").length &&
                c.append('<div class="results"></div>'),
              (d = c.find(".results")))
            : (d = a(b.response_output_div));
          var e;
          switch (b.mode) {
            case "basic":
              e = g;
          ...
          e(c, b, d),
            "button" == b.operation
              ? (0 === c.find("button").length &&
                  0 === c.find("input[type=submit]").length &&
                  0 === c.find("input[type=image]").length &&
                  c
                    .find(".form")
                    .append(
    ...
    (a.fn.accrue.options = {
      ...
      response_basic:
        "<p><strong>Monthly Payment:</strong>$%payment_amount%</p><p><strong>Number of Payments:</strong>%num_payments%</p><p><strong>Total Payments:</strong>$%total_payments%</p><p><strong>Total Interest:</strong>$%total_interest%</p>",
      response_compare:
  ...
  var f = function (a, b, c) {
      var d;
      return (
        a.find(".accrue-" + c).length
          ? (d = a.find(".accrue-" + c))
          : a.find("." + c).length
          ? (d = a.find("." + c))
          : a.find("input[name~=" + c + "]").length
          ? a.find("input[name~=" + c + "]")
          : (d = ""),
        "string" != typeof d
          ? d.val()
          ...
          : (a
              ...
              .append(
                '<div class="accrue-field-' +
                  ...
                  b.default_values[c] +
                  '" />' +
                  (b.field_comments[c].length > 0
                    ? "<small>" + b.field_comments[c] + "</small>"
                    : "") +
                  "</p></div>"
              ),
            a.find("." + c).val())
    ...
    g = function (b, c, d) {
      ...
      if (0 !== g) {
        var h = c.response_basic
          .replace("%payment_amount%", e(g.payment_amount_formatted))
          .replace("%num_payments%", g.num_payments)
          .replace("%total_payments%", e(g.total_payments_formatted))
          .replace("%total_interest%", e(g.total_interest_formatted));
        d.html(h);
    ...
    h = function (b, c, d) {
      ...
      var h = a.loanInfo({
        ...
        i = a.loanInfo({
          amount: f(b, c, "amount"),
          rate: f(b, c, "rate_compare"),
          term: g,
        }),
        j = { loan_1: h, loan_2: i };
      if (0 !== h && 0 !== i) {
        h.total_interest - i.total_interest > 0
          ? (j.savings = h.total_interest - i.total_interest)
          : (j.savings = 0);
        var k = c.response_compare
          .replace("%savings%", e(j.savings.toFixed(2)))
          .replace("%loan_1_payment_amount%", e(i.payment_amount_formatted))
          .replace("%loan_1_num_payments%", i.num_payments)
          .replace("%loan_1_total_payments%", i.total_payments_formatted)
          .replace("%loan_1_total_interest%", e(i.total_interest_formatted))
          .replace("%loan_2_payment_amount%", e(h.payment_amount_formatted))
          .replace("%loan_2_num_payments%", h.num_payments)
          .replace("%loan_2_total_payments%", h.total_payments_formatted)
          .replace("%loan_2_total_interest%", e(h.total_interest_formatted));
        d.html(k);
      } else d.html(c.error_text);
      c.callback(b, j);
    },
    i = function (b, c, d) {
      ...
      if (0 !== g) {
        for (
          var h =
              '<table class="accrue-amortization"><thead><tr><th class="accrue-payment-number">#</th><th class="accrue-payment-amount">Payment Amt.</th><th class="accrue-total-interest">Total Interest</th><th class="accrue-total-payments">Total Payments</th><th class="accrue-balance">Balance</th></tr></thead><tbody>',
            i = g.payment_amount - g.original_amount / g.num_payments,
            j = g.payment_amount - i,
            k = 0,
            l = 0,
            m = parseInt(g.original_amount, 10),
            n = 0;
          n < g.num_payments;
          n++
        ) {
  ...
  (a.loanInfo = function (a) {
    var b = ("undefined" != typeof a.amount ? a.amount : 0)
        .toString()
        .replace(/[^\d.]/gi, ""),
      c = ("undefined" != typeof a.rate ? a.rate : 0)
        .toString()
        .replace(/[^\d.]/gi, ""),
      d = "undefined" != typeof a.term ? a.term : 0;
    d = d.match("y")
      ? 12 * parseInt(d.replace(/[^\d.]/gi, ""), 10)
      : parseInt(d.replace(/[^\d.]/gi, ""), 10);
    var e = c / 100 / 12,
      f = Math.pow(1 + e, d),
      g = (b * f * e) / (f - 1);
    return b * c * d > 0
    ...
    (a.loanAmount = function (a) {
      var b = ("undefined" != typeof a.payment ? a.payment : 0)
          .toString()
          .replace(/[^\d.]/gi, ""),
        c = ("undefined" != typeof a.rate ? a.rate : 0)
          .toString()
