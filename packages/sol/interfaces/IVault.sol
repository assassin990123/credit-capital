interface IVault {
  ...
  function checkIfUserPositionExists ( address _token, address _user ) external view returns ( bool );
  function getLastStake ( address _token, address _user ) external view returns ( tuple );
  function getLastStakeKey ( address _token, address _user ) external view returns ( uint256 );
  ...
  function getUserPosition ( address _token, address _user ) external view returns ( tuple );
  function getUserStakedPosition ( address _token, address _user ) external returns ( uint256 );
  function grantRole ( bytes32 role, address account ) external;
  function hasRole ( bytes32 role, address account ) external view returns ( bool );
  function paused (  ) external view returns ( bool );
  function renounceRole ( bytes32 role, address account ) external;
  function revokeRole ( bytes32 role, address account ) external;
  function setPool ( address _token, uint256 _accCaplPerShare, uint256 _lastRewardBlock ) external returns ( tuple );
  function setStake ( address _token, address _user, uint256 _amount, uint256 _stakeId ) external;
  ...
  function updatePool ( address _token, uint256 _accCaplPerShare, uint256 _lastRewardBlock ) external returns ( tuple );
